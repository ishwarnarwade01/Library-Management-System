...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE library SET bookname ='$bookname',author='$author',availablecopies='$availablecopies',distributedcopies='$distributedcopies',totalcopies='$totalcopies' Where id='$user_id'";
...
if(isset($_GET['id'])){
    ...
    $sql = "SELECT * FROM library WHERE id='$user_id'";
    $result=$conn->query($sql);
    ...
    if($result->num_rows >0){
        while($row = $result->fetch_assoc()){
            ...
            $distributedcopies=$row['distributedcopies'];
...
<center>
    <h2> Books UPDATE FORM</h2>
        ...
        <fieldset>
                <legend><center>Books Updation</center></legend>
                ID:<br>
                ...
                Distributed_Copies: <br>
                <input type="text" name="distributedcopies" value= "<?php echo $distributedcopies?>" >
                <br>
                Total_Copies: <br>
                <input type="text" name="totalcopies" value = "<?php echo $totalcopies;?>">
                <br>
                Available_copies: <br>
                <input type="text" name="availablecopies" value = "<?php echo $availablecopies;?>">
    <br>
